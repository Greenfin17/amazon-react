    ...
    <div className='collapse navbar-collapse' id='navbarNav'>
      <ul className='navbar-nav mr-auto'>
        <li className='nav-item active'>
          <a className='nav-link' href='#' id='all-books'>
            All Books <span className='sr-only'>(current)</span>
          </a>
        </li>
        <li className='nav-item'>
          <a className='nav-link' href='#' id='sale-books'>Books on Sale</a>
        </li>
        <li className='nav-item'>
          <a className='nav-link' href='#' id='authors'>Authors</a>
        </li>
        <li className='nav-item'>
          <a className='nav-link' href='#' id='favorite-authors'>Favorite Authors</a>
        </li>
        <li>
        <input
